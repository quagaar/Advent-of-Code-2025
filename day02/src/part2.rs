...
const ID_VALIDATORS: &[(Range<u64>, &[u64])] = &[
    (10..100, &[11]),
    (100..1000, &[111]),
    (1000..10_000, &[101 /*, 1111*/]),
    (10_000..100_000, &[11111]),
    (100_000..1_000_000, &[1001, 10101 /*, 111111*/]),
    (1_000_000..10_000_000, &[1111111]),
    (10_000_000..100_000_000, &[10001 /*, 1010101, 11111111*/]),
    (100_000_000..1_000_000_000, &[1001001 /*, 111111111*/]),
    (
        1_000_000_000..10_000_000_000,
        &[100001, 101010101 /*, 1111111111*/],
    ),
    (10_000_000_000..100_000_000_000, &[11111111111]),
    (
        100_000_000_000..1_000_000_000_000,
        &[
            1000001, 100010001, /*, 1001001001, 10101010101, 111111111111*/
        ],
    ),
    (1_000_000_000_000..10_000_000_000_000, &[1111111111111]),
    (
        10_000_000_000_000..100_000_000_000_000,
        &[10000001, 1010101010101 /*, 11111111111111*/],
    ),
    (
        100_000_000_000_000..1_000_000_000_000_000,
        &[10000100001, 1001001001001 /*, 111111111111111*/],
    ),
    (
        1_000_000_000_000_000..10_000_000_000_000_000,
        &[
            100000001, /*, 1000100010001, 101010101010101, 1111111111111111*/
        ],
    ),
    (
    ...
    (
        ...
        &[1000000001, 10101010101010101 /*, 111111111111111111*/],
    ),
    (
